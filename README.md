...
**Version:** [0.37.0](CHANGELOG.md#0370---2026-08-17) · see [`CHANGELOG.md`](CHANGELOG.md) for release history and [`docs/releasing.md`](docs/releasing.md) for how releases are cut.
