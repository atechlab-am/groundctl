...
**Version:** [0.39.0](CHANGELOG.md#0390---2026-08-24) · see [`CHANGELOG.md`](CHANGELOG.md) for release history and [`docs/releasing.md`](docs/releasing.md) for how releases are cut.
