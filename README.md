...
**Version:** [0.33.0](CHANGELOG.md#0330---2026-08-16) · see [`CHANGELOG.md`](CHANGELOG.md) for release history and [`docs/releasing.md`](docs/releasing.md) for how releases are cut.
