...
**Version:** [0.30.0](CHANGELOG.md#0300---2026-08-15) · see [`CHANGELOG.md`](CHANGELOG.md) for release history and [`docs/releasing.md`](docs/releasing.md) for how releases are cut.
